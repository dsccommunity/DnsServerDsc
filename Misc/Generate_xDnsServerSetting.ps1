...
$resourceProperties += New-xDscResourceProperty -Name DsAvailable -Type Boolean -Attribute Write -Description "Indicates whether there is an available DS on the DNS Server."
...
$resourceProperties += New-xDscResourceProperty -Name LogIPFilterList -Type String[] -Attribute Write -Description "List of IP addresses used to filter DNS events written to the debug log."
