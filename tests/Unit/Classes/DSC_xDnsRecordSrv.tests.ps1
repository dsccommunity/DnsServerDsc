...
InModuleScope $ProjectName {
    Describe DSC_xDnsRecordSrv {

        Context 'Constructors' {
            It 'Should not throw an exception when instanciate it' {
                { [DSC_xDnsRecordSrv]::new() } | Should -Not -Throw
            }

            It 'Has a default or empty constructor' {
                $instance = [DSC_xDnsRecordSrv]::new()
                $instance | Should -Not -BeNullOrEmpty
                $instance.GetType().Name | Should -Be 'DSC_xDnsRecordSrv'
            }
        }

        Context 'Type creation' {
            It 'Should be type named DSC_xDnsRecordSrv' {
                $instance = [DSC_xDnsRecordSrv]::new()
                $instance.GetType().Name | Should -Be 'DSC_xDnsRecordSrv'
            }
        }
    ...
    Describe "Testing Get Method" -Tag 'Get' {
        ...
        Context "When the configuration is absent" {
            ...
            It 'Should return Reason because the item is absent' {
                ...
                $getMethodResourceResult.Reasons.Code | Should -Contain 'DSC_xDnsRecordSrv:DSC_xDnsRecordSrv:Ensure'
            }
        }
            ...
            Context 'When the configuration are absent' {
                BeforeEach {
                    ...
                    $script:instanceDesiredState | Add-Member -Force -MemberType ScriptMethod -Name Get `
                        -Value {
                            $mockInstanceCurrentState = [DSC_xDnsRecordSrv]::New()
