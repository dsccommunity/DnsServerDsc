<#
    .SYNOPSIS
        Unit test for DSC_DnsServerStubZone DSC resource.
#>
...
BeforeAll {
    ...
    $script:dscResourceName = 'DSC_DnsServerStubZone'
...
Describe 'DSC_DnsServerStubZone\Get-TargetResource' -Tag 'Get' {
    BeforeAll {
        Mock -CommandName Assert-Module

        $testZoneName = 'example.com'
        $testZoneFile = 'example.com.dns'
        $testZoneMasterServers = '192.168.1.1','192.168.1.2'
        $fakeDnsFileZone = [PSCustomObject] @{
            DistinguishedName      = $null
            ZoneName               = $testZoneName
            ZoneType               = 'Stub'
            MasterServers          = $testZoneMasterServers
...
Describe 'DSC_DnsServerStubZone\Test-TargetResource' -Tag 'Test' {
    BeforeAll {
        Mock -CommandName Assert-Module
    ...
    Context 'When the DNS zone exists' {
        ...
        Context 'When the zone is in the desired state' {
            ...
            It 'Should be $true "MasterServers" is correct' {
                InModuleScope -ScriptBlock {
                    Set-StrictMode -Version 1.0
        ...
        Context 'When the zone is not in the desired state' {
            ...
            It 'Should be $false when "MasterServers" is incorrect' {
                InModuleScope -ScriptBlock {
                    Set-StrictMode -Version 1.0
...
Describe 'DSC_DnsServerStubZone\Set-TargetResource' -Tag 'Set' {
    BeforeAll {
        Mock -CommandName 'Assert-Module'
    ...
    Context 'When the DNS zone does not exist' {
        BeforeAll {
            Mock -CommandName Get-DnsServerZone
            Mock -CommandName Add-DnsServerStubZone -ParameterFilter { $Name -eq $testZoneName }
        }
        ...
        It 'Should call expected mocks' {
            ...
            Should -Invoke -CommandName Add-DnsServerStubZone -ParameterFilter { $Name -eq $testZoneName } -Scope It -Times 1 -Exactly
    ...
    Context 'When the DNS zone does exist' {
        ...
        Context 'When the zone needs updating' {
            Context 'when DNS zone "MasterServers" are incorrect' {
                BeforeAll {
                    Mock -CommandName Get-DnsServerZone -MockWith { return $fakeDnsFileZone }
                    Mock -CommandName Set-DnsServerStubZone -ParameterFilter { $MasterServers -eq '8.8.8.8' }
                }
                ...
                It 'Should call expected mocks' {
                    ...
                    Should -Invoke -CommandName Set-DnsServerStubZone -ParameterFilter { $MasterServers -eq '8.8.8.8' } -Scope It -Times 1 -Exactly
                    Should -Invoke -CommandName Get-DnsServerZone -Scope It -Times 1 -Exactly
                }
            }
            ...
            Context 'When DNS zone "ZoneFile" is incorrect' {
                BeforeAll {
                    Mock -CommandName Get-DnsServerZone -MockWith { return $fakeDnsFileZone }
                    Mock -CommandName Set-DnsServerStubZone -ParameterFilter { $ZoneFile -eq 'nonexistent.com.dns' }
                }
                ...
                It 'Should call expected mocks' {
                    ...
                    Should -Invoke -CommandName Set-DnsServerStubZone -ParameterFilter { $ZoneFile -eq 'nonexistent.com.dns' } -Scope It -Times 1 -Exactly
                    Should -Invoke -CommandName Get-DnsServerZone -Scope It -Times 1 -Exactly
                }
            }
        }
