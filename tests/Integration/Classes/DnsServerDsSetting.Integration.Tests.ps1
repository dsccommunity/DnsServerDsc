...
BeforeDiscovery {
    ...
    $script:dscResourceFriendlyName = 'DnsServerDsSetting'
...
Describe "$($script:dscResourceName)_Integration" {
    ...
    Context ('When using configuration {0}' -f $configurationName) {
        ...
        It 'Should have set the resource and all the parameters should match' {
            ...
            $resourceCurrentState.DirectoryPartitionAutoEnlistInterval | Should -Be '1.00:00:00'
        }
    ...
    Context ('When using configuration {0}' -f $configurationName) {
        ...
        It 'Should have set the resource and all the parameters should match' {
            ...
            $resourceCurrentState.LazyUpdateInterval | Should -Be 3
        }
    ...
    Context ('When using configuration {0}' -f $configurationName) {
        ...
        It 'Should have set the resource and all the parameters should match' {
            ...
            $resourceCurrentState.MinimumBackgroundLoadThreads | Should -Be 1
        }
    ...
    Context ('When using configuration {0}' -f $configurationName) {
        ...
        It 'Should have set the resource and all the parameters should match' {
            ...
            $resourceCurrentState.PollingInterval | Should -Be 180
        }
    ...
    Context ('When using configuration {0}' -f $configurationName) {
        ...
        It 'Should have set the resource and all the parameters should match' {
            ...
            $resourceCurrentState.RemoteReplicationDelay | Should -Be 30
        }
    ...
    Context ('When using configuration {0}' -f $configurationName) {
        ...
        It 'Should have set the resource and all the parameters should match' {
            ...
            $resourceCurrentState.TombstoneInterval | Should -Be '14.00:00:00'
        }
