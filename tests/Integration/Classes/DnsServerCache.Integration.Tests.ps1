...
BeforeDiscovery {
    ...
    $script:dscResourceFriendlyName = 'DnsServerCache'
...
Describe "$($script:dscResourceName)_Integration" {
    ...
    Context ('When using configuration {0}' -f $configurationName) {
        ...
        It 'Should have set the resource and all the parameters should match' {
            ...
            $resourceCurrentState.IgnorePolicies | Should -BeFalse
        }
    ...
    Context ('When using configuration {0}' -f $configurationName) {
        ...
        It 'Should have set the resource and all the parameters should match' {
            ...
            $resourceCurrentState.IgnorePolicies | Should -BeTrue
        }
    ...
    Context ('When using configuration {0}' -f $configurationName) {
        ...
        It 'Should have set the resource and all the parameters should match' {
            ...
            $resourceCurrentState.LockingPercent | Should -Be 80
        }
    ...
    Context ('When using configuration {0}' -f $configurationName) {
        ...
        It 'Should have set the resource and all the parameters should match' {
            ...
            $resourceCurrentState.LockingPercent | Should -Be 100
        }
    ...
    Context ('When using configuration {0}' -f $configurationName) {
        ...
        It 'Should have set the resource and all the parameters should match' {
            ...
            $resourceCurrentState.MaxKBSize | Should -Be 1000
        }
    ...
    Context ('When using configuration {0}' -f $configurationName) {
        ...
        It 'Should have set the resource and all the parameters should match' {
            ...
            $resourceCurrentState.MaxKBSize | Should -Be 0
        }
    ...
    Context ('When using configuration {0}' -f $configurationName) {
        ...
        It 'Should have set the resource and all the parameters should match' {
            ...
            $resourceCurrentState.MaxNegativeTtl | Should -Be '01:00:00'
        }
    ...
    Context ('When using configuration {0}' -f $configurationName) {
        ...
        It 'Should have set the resource and all the parameters should match' {
            ...
            $resourceCurrentState.MaxNegativeTtl | Should -Be '00:15:00'
        }
    ...
    Context ('When using configuration {0}' -f $configurationName) {
        ...
        It 'Should have set the resource and all the parameters should match' {
            ...
            $resourceCurrentState.MaxTtl | Should -Be '3.00:00:00'
        }
    ...
    Context ('When using configuration {0}' -f $configurationName) {
        ...
        It 'Should have set the resource and all the parameters should match' {
            ...
            $resourceCurrentState.MaxTtl | Should -Be '1.00:00:00'
        }
    ...
    Context ('When using configuration {0}' -f $configurationName) {
        ...
        It 'Should have set the resource and all the parameters should match' {
            ...
            $resourceCurrentState.EnablePollutionProtection | Should -BeFalse
        }
    ...
    Context ('When using configuration {0}' -f $configurationName) {
        ...
        It 'Should have set the resource and all the parameters should match' {
            ...
            $resourceCurrentState.EnablePollutionProtection | Should -BeTrue
        }
    ...
    Context ('When using configuration {0}' -f $configurationName) {
        ...
        It 'Should have set the resource and all the parameters should match' {
            ...
            $resourceCurrentState.StoreEmptyAuthenticationResponse | Should -BeFalse
        }
    ...
    Context ('When using configuration {0}' -f $configurationName) {
        ...
        It 'Should have set the resource and all the parameters should match' {
            ...
            $resourceCurrentState.StoreEmptyAuthenticationResponse | Should -BeTrue
        }
