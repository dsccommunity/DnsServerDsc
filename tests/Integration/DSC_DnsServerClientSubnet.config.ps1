...
#>
Configuration DSC_DnsServerClientSubnet_AddIPv4Subnet_Config
{
    Import-DscResource -ModuleName 'DnsServerDsc'

    Node $AllNodes.NodeName
    {
        DnsServerClientSubnet 'Integration_Test'
        {
            Name       = 'ClientSubnetA'
...
#>
Configuration DSC_DnsServerClientSubnet_ChangeIPv4Subnet_Config
{
    Import-DscResource -ModuleName 'DnsServerDsc'
...
#>
Configuration DSC_DnsServerClientSubnet_ArrayIPv4Subnet_Config
{
    Import-DscResource -ModuleName 'DnsServerDsc'
...
#>
Configuration DSC_DnsServerClientSubnet_RemoveIPv4Subnet_Config
{
    Import-DscResource -ModuleName 'DnsServerDsc'
...
<#
    .SYNOPSIS
        This configuration will add a Client Subnet to the DNS Server
#>
Configuration DSC_DnsServerClientSubnet_AddIPv6Subnet_Config
{
    Import-DscResource -ModuleName 'DnsServerDsc'
...
<#
    .SYNOPSIS
        This configuration will add a Client Subnet to the DNS Server
#>
Configuration DSC_DnsServerClientSubnet_ChangeIPv6Subnet_Config
{
    Import-DscResource -ModuleName 'DnsServerDsc'
...
#>
Configuration DSC_DnsServerClientSubnet_ArrayIPv6Subnet_Config
{
    Import-DscResource -ModuleName 'DnsServerDsc'
...
#>
Configuration DSC_DnsServerClientSubnet_RemoveIPv6Subnet_Config
{
    Import-DscResource -ModuleName 'DnsServerDsc'
